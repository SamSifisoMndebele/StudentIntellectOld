...
import com.avidco.studentintellect.pdfviewer.AnimationManager;
import com.avidco.studentintellect.pdfviewer.PDFView;
import com.avidco.studentintellect.pdfviewer.PdfFile;
import com.avidco.studentintellect.pdfviewer.model.LinkTapEvent;
...
import static com.avidco.studentintellect.pdfviewer.util.Constants.Pinch.MAXIMUM_ZOOM;
import static com.avidco.studentintellect.pdfviewer.util.Constants.Pinch.MINIMUM_ZOOM;
...
class DragPinchManager implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener {
    ...
    private com.avidco.studentintellect.pdfviewer.PDFView pdfView;
    private com.avidco.studentintellect.pdfviewer.AnimationManager animationManager;
    ...
    DragPinchManager(PDFView pdfView, com.avidco.studentintellect.pdfviewer.AnimationManager animationManager) {
    ...
    private boolean checkLinkTapped(float x, float y) {
        com.avidco.studentintellect.pdfviewer.PdfFile pdfFile = pdfView.pdfFile;
        if (pdfFile == null) {
            return false;
        }
