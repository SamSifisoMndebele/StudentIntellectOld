...
import static com.avidco.studentintellect.pdfviewer.util.Constants.Cache.CACHE_SIZE;
import static com.avidco.studentintellect.pdfviewer.util.Constants.PRELOAD_OFFSET;

import androidx.annotation.NonNull;

class PagesLoader {

    private final com.avidco.studentintellect.pdfviewer.PDFView pdfView;
