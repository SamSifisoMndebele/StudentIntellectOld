...
import com.avidco.studentintellect.ui.pdfview.PdfViewActivity
...
class MaterialsListAdapter(val activity: Activity, private val moduleCode : String, private val materialIDs : MutableList<String>) :
    RecyclerView.Adapter<MaterialsListAdapter.MaterialViewHolder>(), Filterable {
    ...
    fun loadAd() {
        ...
        InterstitialAd.load(activity,activity.getString(R.string.activity_materialsList_interstitialAdUnitId), adRequest, object : InterstitialAdLoadCallback() {
            override fun onAdFailedToLoad(adError: LoadAdError) {
                this@MaterialsListAdapter.interstitialAd = null
            }
            override fun onAdLoaded(interstitialAd: InterstitialAd) {
                this@MaterialsListAdapter.interstitialAd = interstitialAd
            }
        })
    }
                    ...
                    if (cacheDoc.exists()) {
                        ...
                        document.get(Source.SERVER)
                            ...
                            .addOnFailureListener { e ->
                                ...
                                (activity as MaterialsListActivity).finish()
                            }
                    }
                }
                .addOnFailureListener { e ->
        ...
        private fun bind(materialData: MaterialData, position: Int){
            ...
            menu.setOnClickListener { menu ->
                ...
                dialog.findViewById<TextView>(R.id.material_upload_date).text =
                    materialData.dateAdded?.toDate()?.let { dateInstance.format(it) } ?: "Not available"
